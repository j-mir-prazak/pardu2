...
interface NodeOmxPlayerStatic {
	 ...
	 * @param volume (optional): The initial volume, omxplayer will start with this value (in millibels). If left blank will default to 0.
	 */
	(source?: String, volume?: Number): NodeOmxPlayer;
}
...
interface NodeOmxPlayer extends Event {
	 ...
	 * @param volume (optional): The initial volume, omxplayer will start with this value (in millibels). If left blank will default to 0.
	 */
	newSource(source?: String, volume?: Number): void;
